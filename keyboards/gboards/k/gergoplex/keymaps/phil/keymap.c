...
[SYMB] = LAYOUT_gergoplex(
            ...
            MO(4), KC_TRNS, KC_TRNS,
            KC_TRNS, KC_TRNS, KC_TRNS
    ),
// Keymap 2: Number Pad layer
[NPAD]  LAYOUT_gergoplex(
            KC_WH_U, KC_TRNS, KC_TRNS, KC_TRNS, KC_BTN1,            KC_NLCK, KC_P7, KC_P8, KC_P9, KC_PMNS,
            KC_WH_D, KC_MS_L, KC_MS_U, KC_MS_D, KC_MS_R,            KC_MS_U, KC_P4, KC_P5, KC_P6, KC_PPLS,
            KC_LCTL, KC_LSFT, KC_LGUI, KC_LALT, KC_BTN2,            KC_MS_D, KC_P1, KC_P2, KC_P3, KC_PPLS,
