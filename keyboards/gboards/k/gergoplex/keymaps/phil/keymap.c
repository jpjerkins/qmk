...
[BASE] = LAYOUT_gergoplex(
            ...
            MO(2), KC_LSFT, MO(3),            MO(1), KC_SPC, MO(5)
    ),
...
[SYMB] = LAYOUT_gergoplex(
            ...
            LCTL_T(KC_GRV), LSFT_T(KC_BSLS), LGUI_T(KC_LBRC), LALT_T(KC_RBRC), KC_TRNS,
            KC_BSPC, RALT_T(KC_BSPC), RGUI_T(KC_BSPC), KC_RSFT, KC_RCTL,
            MO(4), KC_TRNS, KC_ENT,
...
[NPAD]  LAYOUT_gergoplex(
            ...
            KC_TRNS, KC_MS_L, KC_MS_U, KC_MS_D, KC_MS_R,            KC_MS_U, KC_P4, KC_P5, KC_P6, KC_PPLS,
            KC_LCTL, LSFT_T(KC_BTN3), LGUI_T(KC_BTN2), LALT_T(KC_BTN1), KC_TRNS,
...
[NFN] = LAYOUT_gergoplex(
            ...
            LCTL_T(KC_F11), LSFT_T(KC_F12), KC_LGUI, KC_LALT, KC_TRNS,
...
[BMOD]  LAYOUT_gergoplex(
            ...
            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
            LCTL_T(KC_Z), LSFT_T(KC_X), LGUI_T(KC_C), LALT_T(KC_V), KC_TRNS,
            KC_TRNS, RALT_T(KC_M), RGUI_T(KC_COMM), RSFT_T(KC_DOT), RCTL_T(KC_SLSH),
            KC_TRNS, KC_TRNS, KC_TRNS,
            KC_TRNS, KC_TRNS, KC_TRNS
    )
};
